...
title: Spigot / Paper API Caller
titleZh: Spigot / Paper API 調用器
description: Generate correct Java API call code for Minecraft Bukkit/Spigot/Paper plugins, covering events, commands, player operations, world operations, ItemStack, NBT, scheduler, and more.
descriptionZh: 為 Minecraft Bukkit/Spigot/Paper 插件產生正確的 Java API 調用代碼，包含事件系統、指令、玩家操作、世界操作、物品堆疊、NBT、調度器等。
version: "1.0.0"
status: active
category: api-integration
categoryLabel: API 整合
categoryLabelEn: API Integration
tags: [api, java, bukkit, spigot, paper, event, command, scheduler, nbt]
triggerKeywords:
  - "如何用 API"
  - "Paper API"
  - "Spigot API"
...
githubPath: Skills/spigot-paper-api-caller/SKILL.md
featured: true
---
